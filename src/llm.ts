...
import { GoogleGenerativeAI } from '@google/generative-ai'; // Import for Gemini
...
export class LLMClient {
  ...
  async determineNextStep(task: string, previousActionResult?: string): Promise<NextStep> {
...
`;
    ...
    try {
      ...
      const nextStep: NextStep = JSON.parse(rawJson);
      return nextStep;
